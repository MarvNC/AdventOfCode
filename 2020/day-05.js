...
// part 1
console.log(input.reduce((prev, curr) => Math.max(getInfo(curr).seatID, prev), 0));
...
function getInfo(string) {
  let row = search(string.substr(0, MAX));
  let column = search(string.substr(MAX));
  return {
    row: row,
    column: column,
    seatID: row * 8 + column,
